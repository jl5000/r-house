...
Given there are 4 roles, I'm curious to see how well k-means is able to distinguish between them if we assume 4 cluster:
...
Interesting! Three of the clusters seem to be capuring support, attacker, and tank characters pretty well, however the fourth cluster seems to be a bit of a mess...this probably because healing abilities are given to a range of characters. 

This seems to be a pretty good algorithm, I'm interested to see how other compare. Next up, hierarchical clustering!
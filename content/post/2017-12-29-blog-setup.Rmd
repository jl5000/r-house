...
Unfortunately, stopping the server crashes RStudio, so I have to run `options(blogdown.generator.server = TRUE)` before running it to stop it crashing when it's stopped. 

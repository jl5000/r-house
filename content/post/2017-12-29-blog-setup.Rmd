...
After reading the `blogdown` documentation a bit more carefully, I've modified my workflow so I let Netlify build my website for me. This required making the following changes:
...
* Modifying my Netlify settings to build using the `hugo_0.31` build command;

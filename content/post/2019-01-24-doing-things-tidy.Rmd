...
Therefore, I've created a simple search tool using the `DT` package - let's call it tidysearch - for base R users to search for an appropriate tidyverse function, and for tidyverse users to be able to search for a base R function. You can find it [here](https://r-house.netlify.com/page/base-r-tidyverse-functions/) (thanks Gerardo!).

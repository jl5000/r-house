...
However, some of us who began with the tidyverse do not have the experience to be able to choose an appropriate base R function when the tidyverse is not available or not appropriate for the problem as hand (e.g. lack of internet access, developing a package with minimal dependencies).
